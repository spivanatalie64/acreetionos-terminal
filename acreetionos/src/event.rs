...
use acreetionos_terminal::event::{Event as TerminalEvent, EventListener, Notify};
use acreetionos_terminal::event_loop::Notifier;
use acreetionos_terminal::grid::{BidirectionalIterator, Dimensions, Scroll};
use acreetionos_terminal::index::{Boundary, Column, Direction, Line, Point, Side};
use acreetionos_terminal::selection::{Selection, SelectionType};
use acreetionos_terminal::term::cell::Flags;
use acreetionos_terminal::term::search::{Match, RegexSearch};
use acreetionos_terminal::term::{self, ClipboardType, Term, TermMode};
use acreetionos_terminal::vte::ansi::NamedColor;
...
impl<'a, N: Notify + 'a, T: EventListener> input::ActionContext<T> for ActionContext<'a, N, T> {
    ...
    fn spawn_new_instance(&mut self) {
        ...
        // Reuse the arguments passed to AcreetionOS Terminal for the new instance.
