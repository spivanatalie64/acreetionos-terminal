...
use acreetionos_terminal::grid::{BidirectionalIterator, Dimensions};
use acreetionos_terminal::index::{Boundary, Column, Direction, Line, Point};
use acreetionos_terminal::term::cell::Hyperlink;
use acreetionos_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use acreetionos_terminal::index::{Column, Line};
    use acreetionos_terminal::term::test::mock_term;
    use acreetionos_terminal::vte::ansi::Handler;
