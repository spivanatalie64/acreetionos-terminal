...
use acreetionos_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `acreetionos_terminal` damage information into renderer damaged rects.
