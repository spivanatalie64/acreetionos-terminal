...
use acreetionos_config_derive::{ConfigDeserialize, SerdeReplace};
use acreetionos_terminal::term::Config as TermConfig;
use acreetionos_terminal::term::search::RegexSearch;
use acreetionos_terminal::tty::{Options as PtyOptions, Shell};
...
pub struct UiConfig {
    ...
    /// Config for the acreetionos_terminal itself.
