...
use acreetionos_terminal::event::{Event, EventListener};
use acreetionos_terminal::grid::{Dimensions, Grid};
use acreetionos_terminal::index::{Column, Line};
use acreetionos_terminal::term::cell::Cell;
use acreetionos_terminal::term::test::TermSize;
use acreetionos_terminal::term::{Config, Term};
use acreetionos_terminal::vte::ansi;
...
fn ref_test(dir: &Path) {
    let recording = read_u8(dir.join("acreetionos-terminal.recording"));
